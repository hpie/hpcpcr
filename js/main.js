...
{
		var _currentPath = $(location).attr('pathname'); 
		console.log(_currentPath);
		
		if(_currentPath.indexOf("index.php"))
		{
			//class="active"
			alert($("#homeli").get(0).tagName);
			alert($("#aboutlnk").get(0).tagName);
			...
			//$("#homelnk").toggleClass("active");
		}else if(_currentPath == "about.php")
		{
			...
			$("#contactli").removeClass("active");
			//$("#homelnk").toggleClass("active");
		}else if(_currentPath == "activity.php")
		{
			...
			$("#contactli").removeClass("active");
			//$("#homelnk").toggleClass("active");
		}else if(_currentPath == "gallery.php")
		{
			$("#galleryli").addClass("active");
			...
			$("#contactli").removeClass("active");
			//$("#homelnk").toggleClass("active");
		}else if(_currentPath == "contact.php")
		{
